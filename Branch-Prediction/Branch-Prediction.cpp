...
void quickSort(int arr[], int lowest, int highest, DynamicBranchPredictor &dynamicBranchPredictor)
{
...
int main()
{    
    DynamicBranchPredictor dynamicBranchPredictor(3, 1, 5);
    dynamicBranchPredictor.init(false);
    
    int arr[] = { 15,7,1,3,12,17,5,13,14,100,19,9,50,8,80,2,16,4,10,11,60,15,10,1};
    int size = sizeof(arr) / sizeof(arr[0]);
    quickSort(arr,0,size-1,dynamicBranchPredictor);
